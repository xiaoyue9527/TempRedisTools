...
class RatingSystem {
     ...
     */
    constructor(redis, ratingKey) {
        this.redis = redis;
        this.rating = new SortedSet_1.CacheSortedSet(ratingKey, { appName: "app", funcName: "rating" }, redis);
    }
    /**
     * 添加评分
     ...
     */
    async updateRating(itemId, score) {
        await this.rating.incrementBy(itemId, score);
    }
}
exports.RatingSystem = RatingSystem;
