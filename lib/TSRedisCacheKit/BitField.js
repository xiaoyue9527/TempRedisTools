...
exports.CacheBitField = void 0;
const base_1 = require("./base");
class CacheBitField extends base_1.BaseCache {
    /**
     * 设置位域的某一位
     * @param offset - 位的偏移量
     ...
     * @returns 之前的位值
     */
    async setbit(offset, value, suffix = "") {
        const result = await this.redis.setbit(this.createKey(suffix), offset, value ? 1 : 0);
        return result > 0;
    }
    /**
     * 获取位域的某一位
    ...
    async bitop(operation, destKey, keys) {
        return await this.redis.bitop(operation, destKey, ...keys.map(this.createKey.bind(this)));
    }
}
exports.CacheBitField = CacheBitField;
