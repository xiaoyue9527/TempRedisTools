...
exports.CacheString = void 0;
const base_1 = require("./base");
class CacheString extends base_1.BaseCache {
    /**
     * 设置字符串值
     * @param key - 缓存键
     * @param value - 缓存值
     ...
     * @returns 是否成功设置
     */
    async setnxWithExpire(key, value, EX) {
        const redisKey = this.createKey(key);
        const redisValue = this.dataToString(value);
...
exports.CacheString = CacheString;
