import { CacheString } from "../src/TSRedisCacheKit/String";
...
describe("CacheString", () => {
  ...
  beforeEach(() => {
    ...
    cacheString = new CacheString("testPrefix", cacheOption, redisClient);
  });
  ...
  test("should set a string value", async () => {
    ...
    expect(redisClient.set).toHaveBeenCalledWith(
      "testPrefix-testApp-testFunc-key",
      "value"
    );
  ...
  test("should get and set a new value", async () => {
    ...
    expect(redisClient.getset).toHaveBeenCalledWith(
      "testPrefix-testApp-testFunc-key",
      "newValue"
    );
