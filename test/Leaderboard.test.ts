...
describe("Leaderboard", () => {
  ...
  beforeEach(() => {
    ...
    leaderboard = new Leaderboard(redisClient, "leaderboardKey");
    (leaderboard as any).leaderboard = cacheSortedSet; // Ensure the mocked instance is used
  });
  ...
  test("should get user rank and score", async () => {
    ...
    expect(redisClient.zrevrank).toHaveBeenCalledWith(
      "leaderboardKey",
      "user1"
    );
